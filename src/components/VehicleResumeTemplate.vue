<template>
  <div id="vehicle-resume">
    <div id="vehicle-resume-template" class="body" ref="template">
      <div class="text-center">
        <img height="80" src="../assets/vision-logo-temp.png" alt="" />
        <img
          width="550"
        ...
        <div class="align-left resume">
          <div class="container">
            <img class="icon" height="30" src="../assets/currency.png" alt="" />
            <div>
              <p>Cotação | {{ new Date() | formatDate }}</p>
              <strong class="info"
                >{{ getCurrencyText }} {{ vehicleData.currencyTax }}</strong
              >
            </div>
          </div>
          <div class="container">
            <img class="icon" height="30" src="../assets/car.png" alt="" />
            <div>
              <p>Veículo Cotado</p>
